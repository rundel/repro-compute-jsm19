...
```{r get-shapefiles, include=FALSE}
...
```{r neighbors, echo=FALSE, warning=FALSE, message=FALSE}
...
.footnote[
*The model above and following code is based on Max Joseph's Exact sparse CAR models in Stan which is available [here](http://mc-stan.org/users/documentation/case-studies/mbjoseph-CARStan.html).*
]
